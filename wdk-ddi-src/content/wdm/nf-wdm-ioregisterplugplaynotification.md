...
| **EventCategoryTargetDeviceChange** | [TARGET_DEVICE_REMOVAL_NOTIFICATION](ns-wdm-_target_device_removal_notification.md)<br>[TARGET_DEVICE_CUSTOM_NOTIFICATION](ns-wdm-_target_device_custom_notification)|
